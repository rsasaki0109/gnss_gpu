"""Core predict/update/resample runtime for ParticleFilterDevice."""
...
from gnss_gpu.pf_device_config import init_pf_device_config


class ParticleFilterDeviceRuntime:
    ...
    def initialize(self, position_ecef, clock_bias=0.0, spread_pos=100.0,
        ...
        velocity_init_sigma = finite_float("velocity_init_sigma", velocity_init_sigma)
        if velocity is None:
        ...
        spread_vel = finite_float("spread_vel", spread_vel)
    ...
    def predict(self, velocity=None, dt=1.0, sigma_pos=None, sigma_vel=None,
        ...
        sp = positive_float("sigma_pos", self.sigma_pos if sigma_pos is None else sigma_pos)
        sv = finite_float("sigma_vel", self.sigma_vel if sigma_vel is None else sigma_vel)
        alpha = finite_float(
    ...
    def update(self, sat_ecef, pseudoranges, weights=None, sigma_pr=None, resample=True):
        ...
        sp = positive_float("sigma_pr", self.sigma_pr if sigma_pr is None else sigma_pr)
