...
def build_trip_arrays(
    ...
    *,
    ...
    observation_preparation = _build_observation_preparation_stages(
        ...
        fgo_doppler_only_min_elevation_deg=fgo_doppler_only_min_elevation_deg,
...
def _build_taroz_fgo_candidate_batch(
    ...
    *,
    ...
    candidate = build_trip_arrays(
        ...
        fgo_doppler_only_constellations=bool(getattr(config, "fgo_doppler_only_constellations", False)),
        fgo_doppler_only_min_elevation_deg=float(getattr(config, "fgo_doppler_only_min_elevation_deg", 0.0)),
...
def validate_raw_gsdc2023_trip(
    ...
    *,
    ...
    batch = build_trip_arrays(
        ...
        fgo_doppler_only_constellations=bool(getattr(cfg, "fgo_doppler_only_constellations", False)),
        fgo_doppler_only_min_elevation_deg=float(getattr(cfg, "fgo_doppler_only_min_elevation_deg", 0.0)),
