...
def _build_taroz_fgo_candidate_batch(
    ...
    *,
    ...
    candidate = build_trip_arrays(
        ...
        fgo_glonass_constellation=bool(getattr(config, "fgo_glonass_constellation", False)),
...
def validate_raw_gsdc2023_trip(
    ...
    *,
    ...
    batch = build_trip_arrays(
        ...
        fgo_glonass_constellation=bool(getattr(cfg, "fgo_glonass_constellation", False)),
