...
experiments/results/selector_training_features_v4.csv
"""
...
PHASE19_EXTRA_DIRS = [
    ...
    "experiments/results/libgnss_diag_phase19/gici_full_loosenl",
    "experiments/results/libgnss_diag_phase19/gici_full_tcgif",
    "experiments/results/libgnss_diag_phase19/gici_full_tightpr",
]
PHASE19_EXTRA_LABELS = [
    ...
    "xd_gici_lnl", "xd_gici_tcgif", "xd_gici_tpr",
]
...
def main():
    ...
    out_path = REPO / "experiments/results/selector_training_features_v4.csv"
