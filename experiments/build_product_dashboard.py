...
def main() -> None:
    ...
    parts = [
        ...
        f"<p class='metadata'>Adopted model: <code>current_tight_hold + carry + α=0.75 + isotonic blend 0.75 + GF recovery floor + phase-delta guard</code> · strict nested LORO on 6 runs / {total_windows} windows</p>",
        "<div class='summary'>",
