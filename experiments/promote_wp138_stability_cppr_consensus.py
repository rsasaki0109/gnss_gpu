#!/usr/bin/env python3
"""Promote a holdout-validated WP138 stability/CPPR constant offset."""
...
from select_wp138_stability_cppr_consensus import select
...
def main() -> int:
    ...
    if not target["accepted"]:
        raise RuntimeError("target stability/CPPR selector does not pass")
    holdouts = {}
    ...
    result = {
        "schema": "wp138_stability_cppr_promotion_v1",
