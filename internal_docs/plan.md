...
**最終更新**: 2026-05-21 JST (GSDC2023 Kaggle pivot: TaroZ DD-carrier guarded は trip-level diagnostic で DD broad-apply が regression cause と確認、 private-floor 復旧は 0/4 artifact ready で blocked)
**現在の HEAD**: `main` `1824c7f` + GSDC/TaroZ/private-floor recovery worktree changes
