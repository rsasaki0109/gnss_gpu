...
| Preset | P50 | RMS | 用途 |
|---|---:|---:|---|
| odaiba_reference | 1.38m | 5.02m | DD adaptive floor `0.18` に更新した frozen baseline |
| odaiba_stop_detect | 1.36m | 4.11m | + stop detection, current best。DD adaptive floor は `0.25` 維持 |
