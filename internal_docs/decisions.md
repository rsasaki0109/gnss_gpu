...
根拠:
- [ppc_pf_blocked_clear_sweep_tokyo_run23_mix005_fine2_configs.csv](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/experiments/results/ppc_pf_blocked_clear_sweep_tokyo_run23_mix005_fine2_configs.csv)
...
決定:
- [experiments.md](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/docs/experiments.md): 実験結果
- [decisions.md](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/docs/decisions.md): 採用/不採用理由
- [interfaces.md](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/docs/interfaces.md): 現在の最小 interface
...
決定:
- 先に [exp_ppc_pf_rich_gate_search.py](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/experiments/exp_ppc_pf_rich_gate_search.py) で feature/trajectory dump を作る
- その上で [evaluate_strategies.py](/media/sasaki/aiueo/ai_coding_ws/gnss_gpu/experiments/pf_strategy_lab/evaluate_strategies.py) が variant を比較する
