...
|---|---:|---|
| `odaiba_reference` | `0.18` | weak-DD coverage-hole 調査後の full-run 改善を採用 |
| `odaiba_reference_guarded` | `0.18` | guarded smoother でも RMS が少し改善 |
| `odaiba_stop_detect` | `0.25` | `0.18` は smoother RMS 横ばいだが forward が悪化したため不採用 |
