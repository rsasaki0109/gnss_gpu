...
場所:
- [interfaces.py](/workspace/ai_coding_ws/gnss_gpu/experiments/pf_strategy_lab/interfaces.py)
...
生成元:
- [exp_ppc_pf_rich_gate_search.py](/workspace/ai_coding_ws/gnss_gpu/experiments/exp_ppc_pf_rich_gate_search.py)
...
場所:
- [evaluate_strategies.py](/workspace/ai_coding_ws/gnss_gpu/experiments/pf_strategy_lab/evaluate_strategies.py)
...
場所:
- [cross_validate_families.py](/workspace/ai_coding_ws/gnss_gpu/experiments/pf_strategy_lab/cross_validate_families.py)
...
experiment hook:
- [exp_urbannav_pf3d.py](/workspace/ai_coding_ws/gnss_gpu/experiments/exp_urbannav_pf3d.py) の `run_pf_standard(..., quality_veto_config=None, guide_reference_positions=None, guide_initial_from_reference=False, guide_mode=\"always\", guide_satellite_max=None, rescue_reference_positions=None, rescue_distance_m=None)` と `run_pf3d_variant(...)` は、同じ veto config を PF update にも適用できる
...
- [exp_urbannav_fixed_eval.py](/workspace/ai_coding_ws/gnss_gpu/experiments/exp_urbannav_fixed_eval.py) は experiment-only method として `PF+AdaptiveGuide-10K` を持つ
...
- [urbannav_fixed_eval_external_gej_trimble_qualityveto_epochs_epochs.csv](/workspace/ai_coding_ws/gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_qualityveto_epochs_epochs.csv) or isolated `__*__*_epochs.csv`
- [ppc_pf3d_tokyo_run1_g_100_plateau_summary.csv](/workspace/ai_coding_ws/gnss_gpu/experiments/results/ppc_pf3d_tokyo_run1_g_100_plateau_summary.csv)
