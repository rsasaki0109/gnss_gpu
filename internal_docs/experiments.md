...
pilot dump:
- feature dump:
  [ppc_pf_rich_gate_t23_n2_v2_features.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_t23_n2_v2_features.csv)
- trajectory dump:
  [ppc_pf_rich_gate_t23_n2_v2_trajectories.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_t23_n2_v2_trajectories.csv)
- base metrics:
  [ppc_pf_rich_gate_t23_n2_v2_bases.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_t23_n2_v2_bases.csv)
...
- feature dump:
  [ppc_pf_rich_gate_positive6_v2_features.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_positive6_v2_features.csv)
- trajectory dump:
  [ppc_pf_rich_gate_positive6_v2_trajectories.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_positive6_v2_trajectories.csv)
- base metrics:
  [ppc_pf_rich_gate_positive6_v2_bases.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_positive6_v2_bases.csv)
...
- [ppc_holdout_segments_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_segments_r200_s200_best.csv)
...
実装は [strategies.py](gnss_gpu/experiments/pf_strategy_lab/strategies.py) に集約する。
...
proxy 指標は [evaluate_strategies.py](gnss_gpu/experiments/pf_strategy_lab/evaluate_strategies.py) が自動生成する。
これは人間レビューの代替ではなく、比較の初期ふるいとして使う。

## pilot 結果

strategy summary:
[pf_strategy_lab_t23_n2_summary.csv](gnss_gpu/experiments/results/pf_strategy_lab_t23_n2_summary.csv)

run-wise metrics:
[pf_strategy_lab_t23_n2_runs.csv](gnss_gpu/experiments/results/pf_strategy_lab_t23_n2_runs.csv)
...
strategy summary:
[pf_strategy_lab_positive6_summary.csv](gnss_gpu/experiments/results/pf_strategy_lab_positive6_summary.csv)

run-wise metrics:
[pf_strategy_lab_positive6_runs.csv](gnss_gpu/experiments/results/pf_strategy_lab_positive6_runs.csv)
...
- [ppc_holdout_candidates_tokyo_run1_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_tokyo_run1_r200_s200_best.csv)
- [ppc_holdout_candidates_tokyo_run2_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_tokyo_run2_r200_s200_best.csv)
- [ppc_holdout_candidates_tokyo_run3_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_tokyo_run3_r200_s200_best.csv)
- [ppc_holdout_candidates_nagoya_run1_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_nagoya_run1_r200_s200_best.csv)
- [ppc_holdout_candidates_nagoya_run2_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_nagoya_run2_r200_s200_best.csv)
- [ppc_holdout_candidates_nagoya_run3_r200_s200_best.csv](gnss_gpu/experiments/results/ppc_holdout_candidates_nagoya_run3_r200_s200_best.csv)

holdout dump:
- [ppc_pf_rich_gate_holdout6_r200_s200_features.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_holdout6_r200_s200_features.csv)
- [ppc_pf_rich_gate_holdout6_r200_s200_trajectories.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_holdout6_r200_s200_trajectories.csv)
- [ppc_pf_rich_gate_holdout6_r200_s200_bases.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_holdout6_r200_s200_bases.csv)

strategy summary:
- [pf_strategy_lab_holdout6_r200_s200_summary.csv](gnss_gpu/experiments/results/pf_strategy_lab_holdout6_r200_s200_summary.csv)

run-wise metrics:
- [pf_strategy_lab_holdout6_r200_s200_runs.csv](gnss_gpu/experiments/results/pf_strategy_lab_holdout6_r200_s200_runs.csv)

family cross-validation:
- [pf_strategy_family_cv_positive6_holdout6_configs.csv](gnss_gpu/experiments/results/pf_strategy_family_cv_positive6_holdout6_configs.csv)
- [pf_strategy_family_cv_positive6_holdout6_family_best.csv](gnss_gpu/experiments/results/pf_strategy_family_cv_positive6_holdout6_family_best.csv)
...
freeze sweep:
- [pf_strategy_entry_veto_freeze_configs.csv](gnss_gpu/experiments/results/pf_strategy_entry_veto_freeze_configs.csv)
- [pf_strategy_entry_veto_freeze_best.csv](gnss_gpu/experiments/results/pf_strategy_entry_veto_freeze_best.csv)
...
grid search summary:
[ppc_pf_rich_gate_t23_n2_v2_best.csv](gnss_gpu/experiments/results/ppc_pf_rich_gate_t23_n2_v2_best.csv)
...
データ取得:
- subset fetcher:
  [fetch_urbannav_subset.py](gnss_gpu/experiments/fetch_urbannav_subset.py)
- fixed evaluator:
  [exp_urbannav_fixed_eval.py](gnss_gpu/experiments/exp_urbannav_fixed_eval.py)

結果ファイル:
- clean aggregate runs:
  [urbannav_fixed_eval_external_g_ublox_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_g_ublox_runs.csv)
- clean aggregate summary:
  [urbannav_fixed_eval_external_g_ublox_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_g_ublox_summary.csv)
- Shinjuku fresh rerun:
  [urbannav_fixed_eval_shinjuku_g_ublox_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_shinjuku_g_ublox_runs.csv)
...
結果ファイル:
- [urbannav_fixed_eval_external_g_trimble_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_g_trimble_runs.csv)
- [urbannav_fixed_eval_external_g_trimble_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_g_trimble_summary.csv)
- [urbannav_fixed_eval_external_g_trimble_diag_epochs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_g_trimble_diag_epochs.csv)
- [urbannav_trimble_pf_vs_ekf_diagnostics.csv](gnss_gpu/experiments/results/urbannav_trimble_pf_vs_ekf_diagnostics.csv)
- [urbannav_trimble_tail_diagnostics.csv](gnss_gpu/experiments/results/urbannav_trimble_tail_diagnostics.csv)
...
- [urbannav_fixed_eval_external_gej_trimble_wls_v2_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_wls_v2_runs.csv)
- [urbannav_trimble_common_epoch_wls_compare.csv](gnss_gpu/experiments/results/urbannav_trimble_common_epoch_wls_compare.csv)
...
script:
- [exp_urbannav_multignss_stabilization.py](gnss_gpu/experiments/exp_urbannav_multignss_stabilization.py)

結果ファイル:
- [urbannav_multignss_stabilization_trimble_gej_features.csv](gnss_gpu/experiments/results/urbannav_multignss_stabilization_trimble_gej_features.csv)
- [urbannav_multignss_stabilization_trimble_gej_runs.csv](gnss_gpu/experiments/results/urbannav_multignss_stabilization_trimble_gej_runs.csv)
- [urbannav_multignss_stabilization_trimble_gej_summary.csv](gnss_gpu/experiments/results/urbannav_multignss_stabilization_trimble_gej_summary.csv)
- [urbannav_multignss_stabilization_trimble_gej_best.csv](gnss_gpu/experiments/results/urbannav_multignss_stabilization_trimble_gej_best.csv)
...
script / hook:
- [multi_gnss_quality.py](gnss_gpu/python/gnss_gpu/multi_gnss_quality.py)
- [exp_urbannav_baseline.py](gnss_gpu/experiments/exp_urbannav_baseline.py)
- [exp_urbannav_fixed_eval.py](gnss_gpu/experiments/exp_urbannav_fixed_eval.py)

結果ファイル:
- [urbannav_fixed_eval_external_gej_trimble_qualityveto_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_qualityveto_runs.csv)
- [urbannav_fixed_eval_external_gej_trimble_qualityveto_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_qualityveto_summary.csv)
...
script:
- [exp_urbannav_window_eval.py](gnss_gpu/experiments/exp_urbannav_window_eval.py)

結果ファイル:
- [urbannav_window_eval_external_gej_trimble_qualityveto_windows.csv](gnss_gpu/experiments/results/urbannav_window_eval_external_gej_trimble_qualityveto_w500_s250_windows.csv)
- [urbannav_window_eval_external_gej_trimble_qualityveto_comparisons.csv](gnss_gpu/experiments/results/urbannav_window_eval_external_gej_trimble_qualityveto_w500_s250_comparisons.csv)
- [urbannav_window_eval_external_gej_trimble_qualityveto_summary.csv](gnss_gpu/experiments/results/urbannav_window_eval_external_gej_trimble_qualityveto_w500_s250_summary.csv)
- [urbannav_window_eval_external_gej_trimble_qualityveto_wins.png](gnss_gpu/experiments/results/urbannav_window_eval_external_gej_trimble_qualityveto_w500_s250_wins.png)
...
script / support:
- [fetch_urbannav_hk_subset.py](gnss_gpu/experiments/fetch_urbannav_hk_subset.py)
- [urbannav.py](gnss_gpu/python/gnss_gpu/io/urbannav.py)

結果ファイル:
- [urbannav_fixed_eval_hk20190428_g_ublox_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_g_ublox_summary.csv)
...
script / hook:
- [exp_urbannav_pf3d.py](gnss_gpu/experiments/exp_urbannav_pf3d.py)
- [exp_urbannav_fixed_eval.py](gnss_gpu/experiments/exp_urbannav_fixed_eval.py)
- [test_urbannav_pf_stabilization.py](gnss_gpu/tests/test_urbannav_pf_stabilization.py)

結果ファイル:
- [urbannav_fixed_eval_hk20190428_gc_rescue_v2_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_gc_rescue_v2_summary.csv)
- [urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pf_10k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pf_10k_runs.csv)
- [urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusrobustclear_10k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusrobustclear_10k_runs.csv)
- [urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusekfrescue_10k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusekfrescue_10k_runs.csv)
- [urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusrobustclearplusekfrescue_10k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_rescue_v2__odaiba__pfplusrobustclearplusekfrescue_10k_runs.csv)
...
結果ファイル:
- [urbannav_fixed_eval_external_gej_trimble_guide_policy_3k_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_guide_policy_3k_summary.csv)
- [urbannav_fixed_eval_external_gej_trimble_guide_policy_3k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_guide_policy_3k_runs.csv)
- [urbannav_fixed_eval_hk20190428_gc_guide_policy_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_gc_guide_policy_summary.csv)
- [urbannav_fixed_eval_hk20190428_gc_guide_policy_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_gc_guide_policy_runs.csv)
- [urbannav_fixed_eval_external_gej_trimble_adaptive_3k_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_adaptive_3k_summary.csv)
- [urbannav_fixed_eval_external_gej_trimble_adaptive_3k_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_adaptive_3k_runs.csv)
- [urbannav_fixed_eval_hk20190428_gc_adaptive_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_gc_adaptive_summary.csv)
- [urbannav_fixed_eval_hk20190428_gc_adaptive_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_hk20190428_gc_adaptive_runs.csv)
...
- [urbannav_fixed_eval_external_gej_trimble_adaptive_full_summary.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_adaptive_full_summary.csv)
- [urbannav_fixed_eval_external_gej_trimble_adaptive_full_runs.csv](gnss_gpu/experiments/results/urbannav_fixed_eval_external_gej_trimble_adaptive_full_runs.csv)
...
script:
- [build_paper_assets.py](gnss_gpu/experiments/build_paper_assets.py)

outputs:
- [paper_main_table.csv](gnss_gpu/experiments/results/paper_assets/paper_main_table.csv)
- [paper_main_table.md](gnss_gpu/experiments/results/paper_assets/paper_main_table.md)
- [paper_ppc_holdout.png](gnss_gpu/experiments/results/paper_assets/paper_ppc_holdout.png)
- [paper_urbannav_external.png](gnss_gpu/experiments/results/paper_assets/paper_urbannav_external.png)
- [paper_bvh_runtime.png](gnss_gpu/experiments/results/paper_assets/paper_bvh_runtime.png)
...
実装:
- [exp_gsdc2023_robust_wls.py](gnss_gpu/experiments/exp_gsdc2023_robust_wls.py)
- [gsdc2023_robust_wls_eval.csv](gnss_gpu/experiments/results/gsdc2023_robust_wls_eval.csv)
...
実装:
- [gsdc_dgnss.py](gnss_gpu/python/gnss_gpu/gsdc_dgnss.py)
- [exp_gsdc2023_dgnss.py](gnss_gpu/experiments/exp_gsdc2023_dgnss.py)
...
結果ファイル:
- [widelane_gate_odaiba_sweep.csv](gnss_gpu/experiments/results/widelane_gate_odaiba_sweep.csv)
- [widelane_gate_validation.csv](gnss_gpu/experiments/results/widelane_gate_validation.csv)
...
結果ファイル:
- [per_particle_nlos_phase1_summary.csv](gnss_gpu/experiments/results/per_particle_nlos_phase1_summary.csv)
- [per_particle_nlos_phase1_sweep.csv](gnss_gpu/experiments/results/per_particle_nlos_phase1_sweep.csv)
